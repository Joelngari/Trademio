...
export default function AdminBotPurchases() {
  ...
  return (
    <div className="space-y-8">
      ...
      {message && (
        <div className={`p-4 rounded-xl border flex items-start gap-3 ${message.type === 'success' ? 'bg-green-500/10 border-green-500/20 text-green-500' : 'bg-red-500/10 border-red-500/20 text-red-500'}`}>
                  ...
                  <tr key={bp.id} className="hover:bg-white/[0.01] transition-colors">
                    ...
                    <td className="px-6 py-4">
                      <button
                        ...
                        className="px-3 py-1 bg-[#87ceeb]/10 text-[#87ceeb] hover:bg-[#87ceeb]/20 rounded-lg text-xs font-semibold transition-colors"
                      >
                        Manage
                      </button>
                    </td>
      ...
      {selectedPurchase && (
        <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50 p-4">
          <div className="bg-[#121212] border border-white/10 rounded-3xl max-w-md w-full p-8">
            ...
            <div className="space-y-4 mb-6">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-white/10 border border-white/20 rounded-xl px-4 py-2 text-white font-semibold focus:border-[#87ceeb] outline-none"
                />
                <p className="text-xs text-gray-500 mt-1">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-white/10 border border-white/20 rounded-xl px-4 py-2 text-white text-sm focus:border-[#87ceeb] outline-none"
                />
              </div>
            </div>
            ...
            <div className="flex gap-3">
              <button
                ...
                className="flex-1 bg-[#87ceeb] text-[#0a0a0a] py-3 rounded-xl font-bold hover:bg-[#76b9d6] transition-all disabled:opacity-50 flex items-center justify-center gap-2"
              >
            ...
            <button
              onClick={() => setSelectedPurchase(null)}
              className="w-full mt-3 bg-white/5 text-gray-400 py-2 rounded-xl font-semibold hover:bg-white/10 transition-all"
            >
              Cancel
            </button>
          </div>
